Aprendendo React, neste caso, aplicações do useState, useEffect e useContext em um site. Página que simula um carrinho de compras. Possui as seguintes funcionalidades:
